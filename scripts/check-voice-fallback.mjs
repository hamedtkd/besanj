...
if (pkg.version !== "1.5.1") {
  failures.push("package version must be 1.5.1");
}
...
if (!serviceWorker.includes(loaderPath) || !serviceWorker.includes("besanj-shell-v18")) {
  failures.push("PWA shell v18 must cache the same-origin Transformers.js loader");
}
